...
tf.app.flags.DEFINE_string('train_dir', 'cnn_roi_logs_train', """Directory where to write event logs and checkpoint.""")
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with tf.device('/cpu:0'):
            images, labels = cnn_roi.distorted_inputs()
        ...
        train_op = cnn_roi.train(loss, global_step)
