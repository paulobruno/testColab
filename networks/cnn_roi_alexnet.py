...
tf.app.flags.DEFINE_string('data_dir', 'cnn_roi_data', """Path to the CIFAR-10 data directory.""")
...
def inference(images, isTraining):
  ...
  # pool5
  pool5 = tf.nn.max_pool(norm2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], 
                         padding='VALID', name='pool2')
  ...
  dropout = tf.layers.dropout(inputs=fc8, rate=0.5, training=isTraining)
